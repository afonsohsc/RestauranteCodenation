...
namespace RestauranteCodenation.Data.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public async Task<bool> Incluir(string login, string email, string senha, string perfil = null)
        {
            ...
            var retorno = await _userManager.CreateAsync(usuario, senha);

            //if (retorno.Succeeded)
            //{
            //    await _userManager.AddToRoleAsync(usu, perfil);
            //}
